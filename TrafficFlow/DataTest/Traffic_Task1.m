...
figure(3);
subplot(2,2,1);
contourf(xx, yy, abs(u_density'-u_real_EX'), 2, 'Linewidth', 0.1);
set(gca, 'XTick', [1, 4, 7, x(10:4:38)], 'YTick', y(1:12*6:end), 'FontSize', 16);
datetick('y','HH:MM', 'keepticks');
xlabel('Sensor number', 'fontsize', 24) ;
ylabel('Time', 'fontsize', 24);
...
subplot(2,2,2);
contourf(xx, yy, abs(u_density'-u_SARIMA'), 2, 'Linewidth', 0.1);
set(gca, 'XTick', [1, 4, 7, x(10:4:38)], 'YTick', y(1:12*6:end), 'FontSize', 16);
datetick('y','HH:MM', 'keepticks');
xlabel('Sensor number', 'fontsize', 24) ;
ylabel('Time', 'fontsize', 24);
...
subplot(2,2,3);
contourf(xx, yy, abs(u_density'-u_LSTM'), 2, 'Linewidth', 0.1);
set(gca, 'XTick', [1, 4, 7, x(10:4:38)], 'YTick', y(1:12*6:end), 'FontSize', 16);
datetick('y','HH:MM', 'keepticks');
xlabel('Sensor number', 'fontsize', 24) ;
ylabel('Time', 'fontsize', 24);
...
subplot(2,2,4);
contourf(xx, yy,abs(u_density'-u_LSTMKF'), 2, 'Linewidth', 0.1);
set(gca, 'XTick', [1, 4, 7, x(10:4:38)], 'YTick', y(1:12*6:end), 'FontSize', 16);
datetick('y','HH:MM', 'keepticks');
xlabel('Sensor number', 'fontsize', 24) ;
ylabel('Time', 'fontsize', 24);
