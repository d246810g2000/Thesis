...
% plot result
tstart = datenum('2015-10-05 00:00:00');% 開始時間
tend = datenum('2015-10-06 00:00:00');% 結束時間
x = 1:38; % 38個間隔
y = linspace(tstart, tend, 288+1);
[xx, yy] = meshgrid(x, y);

figure(1);
set(gcf,'unit','normalized','position',[0.2,0.2,0.4,0.4])
...
figure(2)
subplot(2,2,1);
contourf(xx, yy, u_real_EX', 4, 'Linewidth', 0.1);
set(gca, 'XTick', [1, 4, 7, x(10:4:38)], 'YTick', y(1:12*6:end), 'FontSize', 16);
datetick('y','HH:MM', 'keepticks');
xlabel('Sensor number', 'fontsize', 24) ;
ylabel('Time', 'fontsize', 24);
...
subplot(2,2,2);
contourf(xx, yy, u_SARIMA', 4, 'Linewidth', 0.1);
set(gca, 'XTick', [1, 4, 7, x(10:4:38)], 'YTick', y(1:12*6:end), 'FontSize', 16);
datetick('y','HH:MM', 'keepticks');
xlabel('Sensor number', 'fontsize', 24) ;
ylabel('Time', 'fontsize', 24);
title('SARIMA', 'FontSize', 24);
caxis([0 150]) 
colorbar;
colormap(mycolor);

subplot(2,2,3);
contourf(xx, yy, u_LSTM', 4, 'Linewidth', 0.1);
set(gca, 'XTick', [1, 4, 7, x(10:4:38)], 'YTick', y(1:12*6:end), 'FontSize', 16);
datetick('y','HH:MM', 'keepticks');
xlabel('Sensor number', 'fontsize', 24) ;
ylabel('Time', 'fontsize', 24);
...
subplot(2,2,4);
contourf(xx, yy, u_LSTMKF', 4, 'Linewidth', 0.1);
set(gca, 'XTick', [1, 4, 7, x(10:4:38)], 'YTick', y(1:12*6:end), 'FontSize', 16);
datetick('y','HH:MM', 'keepticks');
xlabel('Sensor number', 'fontsize', 24) ;
ylabel('Time', 'fontsize', 24);
...
figure(3);
subplot(2,2,1);
contourf(xx, yy, abs(u_density'-u_real_EX'), 3, 'Linewidth', 0.1);
set(gca, 'XTick', [1, 4, 7, x(10:4:38)], 'YTick', y(1:12*6:end), 'FontSize', 16);
datetick('y','HH:MM', 'keepticks');
xlabel('Sensor number', 'fontsize', 24) ;
ylabel('Time', 'fontsize', 24);
...
subplot(2,2,2);
contourf(xx, yy, abs(u_density'-u_SARIMA'), 3, 'Linewidth', 0.1);
set(gca, 'XTick', [1, 4, 7, x(10:4:38)], 'YTick', y(1:12*6:end), 'FontSize', 16);
datetick('y','HH:MM', 'keepticks');
xlabel('Sensor number', 'fontsize', 24) ;
ylabel('Time', 'fontsize', 24);
...
subplot(2,2,3);
contourf(xx, yy, abs(u_density'-u_LSTM'), 3, 'Linewidth', 0.1);
set(gca, 'XTick', [1, 4, 7, x(10:4:38)], 'YTick', y(1:12*6:end), 'FontSize', 16);
datetick('y','HH:MM', 'keepticks');
xlabel('Sensor number', 'fontsize', 24) ;
ylabel('Time', 'fontsize', 24);
...
subplot(2,2,4);
contourf(xx, yy,abs(u_density'-u_LSTMKF'), 3, 'Linewidth', 0.1);
set(gca, 'XTick', [1, 4, 7, x(10:4:38)], 'YTick', y(1:12*6:end), 'FontSize', 16);
datetick('y','HH:MM', 'keepticks');
xlabel('Sensor number', 'fontsize', 24) ;
ylabel('Time', 'fontsize', 24);
